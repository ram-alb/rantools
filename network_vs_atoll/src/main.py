...
from network_vs_atoll.src.gsm.gsm_main import gsm_main
from network_vs_atoll.src.lte.lte_main import lte_main
from network_vs_atoll.src.nr5g.nr_main import nr_main
from network_vs_atoll.src.wcdma.wcdma_main import wcdma_main
